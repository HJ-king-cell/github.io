...
![1602688283615](picture/持续集成/1602688283615.png)
...
![1603172708376](picture/持续集成/1603172708376.png)
...
![1603172952271](picture/持续集成/1603172952271.png)
...
![1604036908430](picture/持续集成/1604036908430.png)
...
![1603175821292](picture/持续集成/1603175821292.png)
...
>
>![1603521604783](picture/持续集成/1603521604783.png)
>
>![1603521622211](picture/持续集成/1603521622211.png)
...
3. 配置
   ...
   ![1603521851632](picture/持续集成/1603521851632.png)
...
3. 查看仓库资源
   ...
   如果上传成功， 可以看到数据:
   ![1603522230134](picture/持续集成/1603522230134.png)
...
1. 进入【系统管理】--> 【全局工具配置】
   ...
   ![1603200359461](picture/持续集成/1603200359461.png)

2. MAVEN配置全局设置

   ![1603200435502](picture/持续集成/1603200435502.png)

3. 指定JDK配置

   ![1603200401796](picture/持续集成/1603200401796.png)



4. 指定MAVEN 目录

   ![1603200472287](picture/持续集成/1603200472287.png)

5. 指定DOCKER目录

   ![1603200520246](picture/持续集成/1603200520246.png)
...
6. 设置远程应用服务主机
   ...
   ![1603735746602](picture/持续集成/1603735746602.png)

   新增凭证，输入用户名和密码保存即可

   ![1603735794051](picture/持续集成/1603735794051.png)
   
   
   
   进入【系统管理】-【系统设置】
   
   ![1603200611899](picture/持续集成/1603200611899.png)
   
   输入主机名称和登陆信息， 点击【check connections】验证， 如果成功， 会显示“Successfull connection”。
   
   ![1603735668415](picture/持续集成/1603735668415.png)
...
![1604240624751](picture/持续集成/1604240624751.png)
...
![1604240864953](picture/持续集成/1604240864953.png)
...
![1604241020907](picture/持续集成/1604241020907.png)
...
- 其中的标签`seata.address`为自定义，指的是seata的服务地址，做出一个变量，适用于不同的环境
  ...
  ![1603554970663](picture/持续集成/1603554970663.png)
...
其他微服务配置请参考资料文件夹的内容，一一进行修改![1603555663933](picture/持续集成/1603555663933.png)
...
![1603556179776](picture/持续集成/1603556179776.png)
...
![1603202842506](picture/持续集成/1603202842506.png)



![1603556912178](picture/持续集成/1603556912178.png)

（2）配置当前heima-leadnews

- 描述项目

![1603556984260](picture/持续集成/1603556984260.png)
...
![1603557100765](picture/持续集成/1603557100765.png)
...
![1603557353285](picture/持续集成/1603557353285.png)

​	maven版本：就是之前在jenkins中配置的maven

​	目标：输入maven的命令  `clean install -Dmaven.test.skip=true`  跳过测试安装

![1603557446935](picture/持续集成/1603557446935.png)

(3)启动项目

创建完成以后可以在主页上看到这个item

![1603557661626](picture/持续集成/1603557661626.png)

启动项目：点击刚才创建的项目，然后Build Now

![1603557703328](picture/持续集成/1603557703328.png)

在左侧可以查看构建的进度：

![1603557774990](picture/持续集成/1603557774990.png)

点进去以后，可以查看构建的日志信息

构建的过程中，会不断的输入日志信息，如果报错也会提示错误信息

![1603557824124](picture/持续集成/1603557824124.png)

jenkins会先从git仓库中拉取代码，然后执行maven的install命令，把代码安装到本地仓库中

最终如果是success则为构建成功

![1603557903228](picture/持续集成/1603557903228.png)

### 3.6 微服务打包配置

（1）新建item，以heima-leadnews-admin微服务为例

![1603558664549](picture/持续集成/1603558664549.png)

(2)配置

- 概述

![1603558714167](picture/持续集成/1603558714167.png)

- 源码管理

![1603558748960](picture/持续集成/1603558748960.png)

- 构建

配置maven

![1603558861469](picture/持续集成/1603558861469.png)
...
![1603558973180](picture/持续集成/1603558973180.png)

执行shell命令

![1603558910209](picture/持续集成/1603558910209.png)

![1603559164996](picture/持续集成/1603559164996.png)
...
![1603559728626](picture/持续集成/1603559728626.png)

容器也已创建完毕

![1603559790306](picture/持续集成/1603559790306.png)
...
![1604414645867](picture/持续集成/1604414645867.png)

打包admin前端工程

![1604414757950](picture/持续集成/1604414757950.png)
...
![1604414964313](picture/持续集成/1604414964313.png)
...
![1604415136689](picture/持续集成/1604415136689.png)
...
![1606923508079](picture/持续集成/1606923508079.png)

安装完毕后，点击内网穿透

![1606923592609](picture/持续集成/1606923592609.png)
...
![1606923685544](picture/持续集成/1606923685544.png)

连接成功效果如下，提供了域名

![1606923974163](picture/持续集成/1606923974163.png)

可以使用提供的域名访问网站

![1606924115588](picture/持续集成/1606924115588.png)
...
![1603561759310](picture/持续集成/1603561759310.png)

设置私有仓库的地址和端口：192.168.200.100:5000

![1603561845027](picture/持续集成/1603561845027.png)

- 源码管理 与之前相同

![1603561936319](picture/持续集成/1603561936319.png)

- 构建

![1603561964087](picture/持续集成/1603561964087.png)

执行 Execute shell

![1603740183900](picture/持续集成/1603740183900.png)
...
![1603740248892](picture/持续集成/1603740248892.png)
...
![1603740369748](picture/持续集成/1603740369748.png)
...
![1603740622092](picture/持续集成/1603740622092.png)
...
![1603560413464](picture/持续集成/1603560413464.png)



（1）触发远程构建

![1603560501050](picture/持续集成/1603560501050.png)

触发构建 url： http://192.168.200.100:16060/job/leadnews-admin/build?token=88888888

(2)配置需要触发的工程

![1603560884276](picture/持续集成/1603560884276.png)

(3)定时构建（ Build periodically）

![1603560678836](picture/持续集成/1603560678836.png)
...
![1603560967320](picture/持续集成/1603560967320.png)
...
![1606929689394](picture/持续集成/1606929689394.png)
...
![1606929726997](picture/持续集成/1606929726997.png)

添加令牌描述，提交，弹出框输入密码

![1606929755320](picture/持续集成/1606929755320.png)

复制令牌

![1606929779247](picture/持续集成/1606929779247.png)
...
![1606929817791](picture/持续集成/1606929817791.png)
...
![1606929845138](picture/持续集成/1606929845138.png)
...
![1606929890564](picture/持续集成/1606929890564.png)

点击构建触发器页签,勾选`Gitee webhook`

![1606929947046](picture/持续集成/1606929947046.png)

生成Gitee Webhook密码

![1606929980749](picture/持续集成/1606929980749.png)
...
![1606930088046](picture/持续集成/1606930088046.png)
...
![1606930153212](picture/持续集成/1606930153212.png)

但在点击添加时，提示失败 gitee中需要配置一个公有IP或域名，这里我们可以通过内网穿透来解决

![1606930181199](picture/持续集成/1606930181199.png)

这个时候需要使用内网穿透来映射本地的ip和端口号

![1606930276099](picture/持续集成/1606930276099.png)

在gitee中将上面的外网地址替换之前的ip和端口部分，再次添加

![1606930326225](picture/持续集成/1606930326225.png)
...
![1606930472587](picture/持续集成/1606930472587.png)
